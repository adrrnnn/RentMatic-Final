...
import { Users, Edit, Trash2, Mail, Phone, DollarSign, MapPin, User, Building2 } from "lucide-react";
            ...
            <div className="flex items-start space-x-4 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${tenant.assignedUnitId ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}>
                    {tenant.assignedUnitId ? "Assigned" : "Unassigned"}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm text-gray-600">
                  ...
                  {tenant.assignedUnitId && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Unit {tenant.assignedUnitId}</span>
                    </div>
                  )}
                </div>
