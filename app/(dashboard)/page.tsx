    ...
    <div className="py-6 space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 text-lg">Here&apos;s what&apos;s happening across your properties today.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/properties">
            <div className="p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-gray-600">Add or manage tenants in your properties</p>
            </div>
          </Link>
